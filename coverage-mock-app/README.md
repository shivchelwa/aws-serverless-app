...
This is a template for coverage-mock-app - Below is a brief explanation of what we have generated for you:
...
* Create an additional API resource (e.g. /coverage/{proxy+}) and return the name requested through this new path
